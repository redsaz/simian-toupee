...
import com.redsaz.deciservice.api.DeciserviceMediaType;
...
public class NotesResource {
     ...
     */
    @GET
    @Produces(DeciserviceMediaType.NOTES_V1_JSON)
     ...
     */
    @GET
    @Produces({DeciserviceMediaType.NOTE_V1_JSON})
    @Path("{id}/{uriName}")
    ...
    @POST
    @Consumes(DeciserviceMediaType.NOTES_V1_JSON)
    @Produces({DeciserviceMediaType.NOTES_V1_JSON})
    ...
    @POST
    @Consumes(DeciserviceMediaType.NOTE_V1_JSON)
    @Produces({DeciserviceMediaType.NOTE_V1_JSON})
