...
public class NotesResource {
     ...
     */
    @GET
    @Produces(SimianToupeeMediaType.NOTES_V1_JSON)
     ...
     */
    @GET
    @Produces({SimianToupeeMediaType.NOTE_V1_JSON})
    @Path("{id}/{uriName}")
    ...
    @POST
    @Consumes(SimianToupeeMediaType.NOTES_V1_JSON)
    @Produces({SimianToupeeMediaType.NOTES_V1_JSON})
    ...
    @POST
    @Consumes(SimianToupeeMediaType.NOTE_V1_JSON)
    @Produces({SimianToupeeMediaType.NOTE_V1_JSON})
